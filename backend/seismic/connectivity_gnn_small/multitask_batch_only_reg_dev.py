...
from archived.v1.dataset.connectivity_gnn_small.utils_v2_dev import load_edge_list, generate_sample, cal_label_distribution
from archived.v1.dataset.connectivity_gnn_small.modelzoo_rev import *
...
train_data_dir = ['./{}/data_{}_v2'.format(dataset_name, target_id) for target_id in sample_targets]
...
if val_different:
    ...
    target_node_id = 19
    val_num_sample = [100]
    val_data_dir = ['./{}/data_{}_v2'.format(dataset_name, target_node_id)]    # path to load different data
    val_img_dir = ['./{}/img_reg_{}_v2'.format(imageset_name, target_node_id)]      # path to save the prediction
